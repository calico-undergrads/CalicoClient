...
public class AirspaceIconManager {
	...
	public static Logger logger = Logger.getLogger(AirspaceIconManager.class
			.getName());
	...
	public static Image getIconImage(String iconPath) {
		try {
			...
			Image icon = toolkit.getImage(new URL(AirspaceIconManager
					.getIcon(iconPath)));
