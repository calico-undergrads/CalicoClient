package calico.plugins.loadImageURL.components;

import calico.components.CGroup;
import calico.inputhandlers.CalicoInputManager;
import calico.networking.netstuff.CalicoPacket;
import calico.plugins.loadImageURL.LoadImageUrlNetworkCommands;
import calico.plugins.loadImageURL.inputhandlers.CustomScrapInputHandler;
...
public class CustomScrap extends CGroup {
	...
	public CustomScrap(long uuid, long cuid, long puid) {
		...
		networkLoadCommand = calico.plugins.loadImageURL.LoadImageUrlNetworkCommands.CUSTOM_SCRAP_LOAD;
	}
