...
import calico.plugins.loadImageURL.components.CustomScrap;
...
public class CustomScrapController {
	...
	public static void load_new_image(long new_uuid, long cuuid, int x, int y){
		no_notify_load_and_create_image(new_uuid, cuuid, x, y, "https://www.google.com/images/srpr/logo3w.png");
	}
	...
	public static void no_notify_load_and_create_image(long uuid, long cuuid, int x, int y, String url){
		
		//CGroupImage group = new CGroupImage(uuid, cuuid, img.toImage());
		//no_notify_start(uuid, cuuid, cuuid, true, group);
	}
